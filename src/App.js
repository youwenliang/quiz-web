...
var strings = {
  "外星人": {
    ...
    "talent": ["好運-high", "黑科技指數-full", "想法跳躍度-full"],
  ...
  "控制狂": {
    ...
    "talent": ["耐心度-low", "S傾向-full", "惹人厭指數-full"],
  ...
  "CEO": {
    "id": "3",
    "title": "我說要有光，就有了光。",
    "talent": ["市場眼光-full", "商業嗅覺-high", "野心戰鬥值-full"],
  ...
  "偵探": {
    "id": "4",
    "title": "真相，永遠只有一個！",
    "talent": ["邏輯力-full", "疑心病-full", "八卦力-full"],
  ...
  "科學家": {
    ...
    "talent": ["邏輯力-full", "宅宅程度-high", "書桌混亂度-full"],
  ...
  "大善人": {
    ...
    "talent": ["善良-full", "天真-high", "小幸運-full"],
  ...
  "哲學家": {
    "id": "7",
    "title": "少即是多，色即是空。",
    "talent": ["世俗適應力-low", "理解力-full", "靈性-full"],
  ...
  "鍊金術師": {
    ...
    "talent": ["世俗包袱-low", "存款數字-low", "行動力-full"],
  ...
  "說書人": {
    ...
    "talent": ["文化感知力-full", "狼性-low", "資源回收力-full"],
  ...
  "雞排店長": {
    ...
    "talent": ["炸雞排-full", "賣雞排-full", "吃雞排-full"],
